                ...
                <div className='px-32 border border-green-500 mb-5'>
                    <div className='px-32 flex flex-row justify-between items-center'>
                        <div className='flex flex-row justify-between items-center mb-5'>
                            ...
                            <p className='text-3xl dark:text-white'>{teacher.first_name} {teacher.last_name}</p>
                        </div>
                        <div>
                ...
                <div className='px-32 border border-green-500'>
                    <div className='px-32'>
                        ...
                        <div className='flex flex-row items-center mb-4'>
                            <FontAwesomeIcon icon={teacher.gender === 'male' ? faMale : faFemale}
                                             className='w-10 h-10 dark:text-white'/>&nbsp;&nbsp;
                            <p className='capitalize text-xl font-medium dark:text-white'>{teacher.gender}</p>
                        </div>
                        <div className='flex flex-row items-center mb-4'>
                            <FontAwesomeIcon icon={faAddressCard}
                                             className='w-10 h-10 dark:text-white'/>&nbsp;&nbsp;
                            <p className='capitalize text-xl font-medium dark:text-white'>{teacher.address}</p>
                        </div>
                    </div>
...
export default withRoleGuard(['Admin', 'Teacher'])(TeacherDetails);
