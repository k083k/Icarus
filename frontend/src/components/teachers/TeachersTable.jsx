...
import {deleteTeacher} from "@/services/apiService";
...
const TeachersTable = ({teachers}) => {
    ...
    const handleView = (teacher, title) => {
        ...
        setModalContent(
            <div>
                <p className='mb-2'><strong>Name:</strong>&nbsp;&nbsp;{teacher.first_name}</p>
                <p className='mb-2'><strong>Name:</strong>&nbsp;&nbsp;{teacher.last_name}</p>
                <p className='mb-2'><strong>Email:</strong>&nbsp;&nbsp;{teacher.email}</p>
                <p className='mb-2'><strong>Role:</strong>&nbsp;&nbsp;{teacher.role}</p>
    ...
    const handleProceedDelete = async () => {
        try {
                await deleteTeacher(deleteUserId)
                setShowModal(false);
            ...
            <div className="container w-2/3 h-[80%] mx-auto relative overflow-x-auto sm:rounded-lg">
                ...
                {filteredTeachers.length === 0 ? (
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-md">
                        <thead
                            className="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-900 dark:text-gray-400">
                        <tr>
